...
A **resource's rank** may fall below 0. If you require use of a community's **resources** (see §9.2.2) your actions will be subject to a **penalty** equal to the resource **rank** below 0.
