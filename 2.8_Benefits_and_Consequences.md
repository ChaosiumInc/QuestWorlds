...
If you have a **victory** with an **rank** of *zero* your GM might assign a **consequence** of **rank** *zero* or *one* to represent effort expended in the **victory**. If you have a **victory** with a **rank** of *one* your GM might assign a **consequence** of **rank** *one*, for similar reasons, if it makes dramatic sense.
...
On a **defeat** with a **rank** of *zero* your GM might assign a **benefit** of **rank** *zero* or *one* to represent a glimmer of hope for the PC despite the **defeat**, such as gaining an insight into the **resistance's** weakness. If you have a **defeat** with a **rank** of *one* your GM may assign a **benefit** of **rank** *zero*, for similar reasons, if it makes dramatic sense.
...
The **resistances** to remove a states of adversity is the **base resistance** modified by the **rank** of the **consequence**. So if you were suffering from a **rank** *one* consequence, of -10, you modify the **base resistance** by a **rank** *one* modifier of +10.
...
Your GM may prefer to cancel out **ranks** so that if you have a **rank** *three* benefit from your popularity with the village following saving their holy idol, giving you a +M bonus, but you make a minor social gaff at the mayor's daughter's wedding of **rank** *zero*, you drop one **rank** to *two*, and a +15 bonus.
