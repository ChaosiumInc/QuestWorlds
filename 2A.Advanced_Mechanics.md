...
## 2.10 Degrees of Victory or Defeat

Often all you need to know to interpret the results of a resolution is whether or not you overcame the obstacle and attained your goal. 

At other times, you’ll want to know just how great a victory you achieved, or how soundly you were defeated. This may be important in providing consequences or benefits, that drive further story.

All of the resolution methods have an option to yield the degrees of victory for the winner. The possible degrees of victory, from least to greatest, are: marginal, minor, major, complete. Ties are also possible. 
...
So whilst in a PC vs. PC duel the PC would only be killed on a Complete Defeat, an NPC, described as a resistance, might be killed on any victory, if the NPC's death was the goal around which contest was framed.
...
Your GM will use the degree of victory to determine any side effects or lingering consequences, but be sure to describe the victory in narrative terms.

If the ability being used is a Stretch, then major or complete victories you might score are instead treated as minor victories.
...
Your GM may simply determine these from what makes fictional sense, given the agreed prize for the contest, as described above. Optionally your GM may impose Consequences of Defeat or provide Benefits of Victory if they desire ongoing penalties or bonuses. This rule is used in conjunction with Degrees of Victory. Your GM should always respond to the flow of the story, if narrative consequences are enough, they should not reach for additional mechanical penalties.
