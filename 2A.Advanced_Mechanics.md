...
Sometimes you will face large numbers of individually inconsequential opponents. Your GM can treat many as one. Your GM divides the number of minor opponents by the number of contesting PCs. Your GM then treats each of these sections of the crowd as a single opponent with one **rating**. Their numbers are factored into the **rating** your GM assigns to them.
