...
In a **group simple contest** rather than overall **victory** going to the side with the plurality of **victories**, each side scores a number of **resource points** for their side on a **victory**. The number of **RPs** is determined by the table below (see §9.2.3.1). After all the exchange have been concluded, your GM uses the the difference in **resource points** between the two groups and table §9.2.3.2 to determine the **degree of victory or defeat**
