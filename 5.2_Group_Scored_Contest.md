...
On a victory, you reduce the number of **resolution points** by *one* more than the **rank** of the **victory**. On a defeat, you increase the number of **resolution points** by *one* more than the **rank** of the **resistance's** **victory**. See table §5.1.2.1.
