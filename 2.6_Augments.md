...
If the use of the **ability** to augment seems unlikely to fail, your GM simply awards you a **rank** *zero* **bonus**, or +5. If your description of how you were using the **augmenting ability** was dramatic or entertaining, your GM may increase this to a **rank** *one* **bonus**, or +10.
...
On a **victory** base the **bonus** of the **augment** off the **rank** of the **victory**. So a **rank** *zero* **victory** yields a **rank** *zero* bonus (+5). On a **defeat** award a +5 bonus, but apply a penalty related to **rank** of the **defeat** to the **tactic** used to **augment**, as described above.
