...
A **contest** mirrors the first approach. A **long contest** mirrors the second. If your GM wants to focus on how you complete a sequence of tasks to overcome the **story obstacles** or **story questions** then then use a **long contest**.
