...
Your GM distributes each of the **ranks** 0-4 between the five **resources**. So each  of the **modifiers**: +M, +15, +10 +5 and 0 should apply to one resource. Note that the size of the group doesn’t affect the **ranks**.
