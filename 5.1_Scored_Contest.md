...
You score **resolution points** equal to *one* more than the **rank** of the **outcome**. So a *zero* **rank** **outcome** produces *one* **resolution point**, a *one* **rank** **outcome** produces *two* **resolution points** and so on. (You can take the shortcut of adding *one* to the difference in **successes** of the two rolls, if your prefer to think of it that way).
