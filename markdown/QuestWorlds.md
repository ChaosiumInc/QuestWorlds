...
To determine the winning side’s victory level, as opposed to individual results, if there is only one opponent, use their consequence of defeat, otherwise, use the second-worst consequence among the defeated opponents.
...
5. Determine Degree of Success based on Rising Action or Climax (above).
6. Determine Benefits of Victory or Consequences of Defeat. 
7. Describe the result based on the story obstacle.
