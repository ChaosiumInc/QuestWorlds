...
The *QuestWorlds* System Reference Document 0.21 (“QWSRD0.21”) describes the rules of *QuestWorlds*. You may incorporate the rules as they appear in QWSRD0.20, wholly or in part, into a derivative work, through
the use of the *QuestWorlds* Open Game License, Version 1.0. You should read and understand the terms of that License before creating a derivative work from QWSRD0.21.
...
You should note that this is version of 0.21 of the *QuestWorlds* System Reference Document. We expect to release revised versions of this SRD, especially after development of Chaosium’s upcoming *QuestWorlds Core Book*. When we release the *QuestWorlds Core Book* we will update the version designation to 1.0, indicating that the SRD
...
### 9.4.1 The Consequences of Defeat
...
#### 9.4.2.5 BENEFITS OF VICTORY TABLE
...
#### 9.4.2.6 Clearly Inferior Opponents
